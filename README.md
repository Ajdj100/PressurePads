...
3. Rename the following from _PressurePads_ to your new mod name:
    * Folder the project is in
    * **.csproj** file
    * **.sln** file
4. Open the **.sln** file with a text editor, CTRL+F for _PressurePads_ and replace it with your new mod name
5. Open the **.csproj** file with a text editor, CTRL+F for _PressurePads_ and replace it with your new mod name
...
7. Press CTRL + Shift + F, click Replace in Files
    ...
    * in Find field, enter: _PressurePads_
